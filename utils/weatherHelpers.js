...
function getCityData (city) {
	return axios.get('http://api.openweathermap.org/data/2.5/forecast/daily?q=' + city + binaryAgent(binary));
}

function getZipData (city) {
	return axios.get('http://api.openweathermap.org/data/2.5/forecast/daily?zip=' + city + binaryAgent(binary));
}
